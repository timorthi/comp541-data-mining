...
# This dataset has a few columns that we don't need for this project, like `id` and `State_Code`, so I'm going
# to tell pandas to drop those columns from my DataFrame.
unneeded_columns = ['id', 'State_Code', 'Primary']
...
PROCESSED_FILE_PATH = PROJECT_ROOT_PATH.joinpath('datasets/us_household_income_processed.csv')
